...
const HABITS = [
    ...
    {
        "name": "Yoga",
        "description": "Perform yoga exercises for flexibility.",
        "category": "Fitness",
        "frequency": "Daily",
        "targetDays": 7,
        "color": "#1ABC9C",
    ...
    {
        "name": "Stretching",
        "description": "Stretch muscles after waking up.",
        "category": "Fitness",
        "frequency": "Daily",
        "targetDays": 7,
        "color": "#E74C3C",
    ...
    {
        "name": "Running",
        "description": "Run for improving stamina.",
        "category": "Fitness",
        "frequency": "Weekly",
        "targetDays": 5,
        "color": "#C0392B",
...
const run = async() => {
    ...
    for (const h of todayDoneHabits) {
        await HabitLog.updateOne({ userId: user._id, habitId: h._id, completedDate: today }, { $setOnInsert: { userId: user._id, habitId: h._id, completedDate: today } }, { upsert: true });
    }
